...
class UserController extends AbstractActionController
{
     ...
     * @var string
     */
    protected $failedLoginMessage = 'Combinacion de usuario y contraseña incorrecto. Por favor intente nuevamente!.';
    ...
    public function indexAction()
    {
        ...
        return new ViewModel(array(
            ...
            'emailuser' => $this->zfcUserAuthentication()->getIdentity()->getEmail(),
            'nameuser' => $this->zfcUserAuthentication()->getIdentity()->getDisplayName(),
            'usuario' => $this->zfcUserAuthentication()->getIdentity()->getUsername(),
        ));
    }
